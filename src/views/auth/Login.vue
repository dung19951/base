<template>
    <form @submit.prevent="login" class="row g-3 needs-validation" novalidate :class="{ 'was-validated': hasError }">
            ...
            <div class="wrap-login row">
                ...
                <div class="validate-form col-md-12 col-lg-6">
                    ...
                    <div class="wrap-input100">
                        <input v-model="user.email" type="text" class="input100 form-control form-control-sm"
                    ...
                    <div class="wrap-input100">
                        <input v-model="user.password" type="password" class="input100 form-control form-control-sm"
                            placeholder="Mật khẩu" autocomplete="true" required>
                        <span class="focus-input100"></span>
                        <span class="symbol-input100">
